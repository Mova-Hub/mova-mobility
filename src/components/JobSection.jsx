...
function JobSection() {
  ...
  return (
    <section className="py-16 font-sans bg-gray-50 lg:py-24" id="careers">
      <div className="container px-4 mx-auto max-w-7xl">
        
        {/* EN-TÊTE & ILLUSTRATION */}
        <div className="flex flex-col items-center justify-between gap-12 mb-16 lg:flex-row lg:mb-20">
        ...
        {/* SYSTÈME DE FILTRAGE */}
        <div className="p-4 mb-10 bg-white border border-gray-100 shadow-sm sm:p-6 rounded-2xl">
                ...
                <div id="application-form">
                  ...
                  {hasSubmitted ? (
                    ...
                    <form onSubmit={handleSubmitApplication} className="space-y-6">
                      ...
                      {/* Bouton Soumettre (Désormais dans le flux du formulaire, pas dans le footer) */}
                      <div className="flex justify-end pt-4">
                        <button 
                          type="submit"
                          disabled={isSubmitting}
                          className="w-full sm:w-auto px-8 py-3.5 text-base font-bold text-white bg-[var(--bs-primary,#0d6efd)] rounded-xl hover:opacity-90 transition-all flex justify-center items-center gap-2 shadow-md disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                          {isSubmitting ? (
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb {
          ...
          border-radius: 8px;
          border: 2px solid #f9fafb; /* Crée un effet de padding */
        }
